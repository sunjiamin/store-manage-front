    ...
    <Row type="flex" justify="center" align="middle" class="login" @keydown.enter.native="submitLogin">
      <!--<mavon-editor :ishljs = "true"></mavon-editor>-->
        <Col :xs="{span:22}" style="width: 368px;">
            <Row class="header">
                <img src="../images/leiwo.png" width="220px"/>
                <div class="description">配件进销存系统</div>
            </Row>
            ...
            <Row class="login-form">
                ...
                <Row type="flex" justify="space-between" class="code-row-bg other-login">
                  ...
                  <router-link to="/jianshu"><a class="forget-pass">简书</a></router-link>
              ...
              if (res.success === true) {
                ...
                this.getRequest("/user/info").then(res => {
                  if (res.success === true) {
                    ...
                    // 编程式的导航 想要导航到不同的 URL，则使用 router.push 方法。这个方法会向 history 栈添加一个新的记录，
